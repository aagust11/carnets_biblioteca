      ...
      <div className="relative w-full max-w-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] text-slate-800 dark:text-slate-100">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-semibold text-slate-900 dark:text-white">Codi Python Generat</h3>
        ...
        <div className="p-6 overflow-y-auto flex flex-col gap-4">
          ...
          <div className="bg-slate-50 dark:bg-slate-950/60 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 text-xs text-slate-700 dark:text-slate-300 flex flex-col gap-2">
            ...
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
              Desa el fitxer com a <code className="text-slate-800 dark:text-slate-200 font-semibold">generar_targetes.py</code> juntament amb <code className="text-slate-800 dark:text-slate-200 font-semibold">davant.png</code> i <code className="text-slate-800 dark:text-slate-200 font-semibold">darrere.png</code> i executa <code className="text-slate-800 dark:text-slate-200 font-semibold">python generar_targetes.py</code>.
            </p>
          </div>
